...
public void getdata(int ss)
{
System.out.println("your sit no is: "+ss);
seat_win(ss)
}

public void seat_win(int ss)
{
if(((ss%3)==0))
System.out.println("Aisle_seat");
else if()
}
...
System.out.println("enter the sit number:");
int s = my.next();
